...
begin
  ...
  { intros s hs,
    ...
    rcases mem_partial_ev_uniformly_uniform_continuous uniform_continuous_sub' hu with ⟨t, ht, hts⟩,
  ...
  { intros s hs,
    rcases mem_partial_ev_uniformly_uniform_continuous uniform_continuous_sub' hs with ⟨t, ht, hts⟩,
...
begin
  ...
  { intros s hs,
    rcases mem_comap_sets.1 hs with ⟨u, hu, hus⟩,
    rcases mem_partial_ev_uniformly_uniform_continuous uc hu with ⟨t, ht, hts⟩,
    ...
    exact mem_sets_of_superset (mem_sets_of_superset ht key) hus },
  { intros s hs,
    rcases mem_partial_ev_uniformly_uniform_continuous uc' hs with ⟨t, ht, hts⟩,
